...
class EmailService {
  ...
  static Future<bool> sendFeedbackEmail({
    ...
    try {
      ...
      final message = Message()
        ..from = const Address(_smtpUsername, 'EnergyX Feedback System')
  ...
  static Future<bool> sendBugReportEmail({
    ...
    try {
      // Create the email message
      final message = Message()
        ..from = const Address(_smtpUsername, 'EnergyX Bug Report System')
        ..recipients.add(_adminEmail)
        ..subject =
  ...
  static String _buildFeedbackEmailTemplate({
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>This email was automatically generated by the EnergyX feedback system.</p>
            </div>
        </div>
    </body>
    </html>
  ...
  static String _buildBugReportEmailTemplate({
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>This email was automatically generated by the EnergyX bug reporting system.</p>

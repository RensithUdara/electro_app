    ...
    return [
      {
        ...
        'answer':
            'Go to the Devices tab and tap the "+" button. Follow the setup wizard to connect your device to the app.',
      },
      {
        'question': 'Why is my device showing offline?',
        'answer':
            'Check your device\'s internet connection and ensure it\'s powered on. If the issue persists, try restarting the device.',
      },
      {
      ...
      },
      {
        ...
        'answer':
            'Yes, as long as your devices are connected to the internet, you can control them from anywhere.',
      },
      {
        'question': 'How do I share device access?',
        'answer':
            'Device sharing features are coming soon. You\'ll be able to invite family members to control shared devices.',
      },
      {
        'question': 'How do I update device firmware?',
        'answer':
            'Device firmware updates are handled automatically. You\'ll receive a notification when an update is available.',
      },
      {
        'question': 'What should I do if my device is not responding?',
        'answer':
            'Try unplugging the device for 10 seconds and then plug it back in. If the issue persists, check your network connection.',
      },
      {
        'question': 'How can I view my device\'s energy consumption?',
        'answer':
            'Go to the device details page and tap on "Energy Usage" to view consumption charts and statistics.',
      },
      {
        'question': 'Can I set schedules for my devices?',
        'answer':
            'Yes, tap on any device and select "Schedule" to set automated on/off times.',
      },
      {
        'question': 'How do I delete a device from my account?',
        'answer':
            'Go to the device settings and select "Remove Device". This will permanently remove the device from your account.',
      },
    ];
  }
}

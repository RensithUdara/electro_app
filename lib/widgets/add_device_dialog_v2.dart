...
class AddDeviceDialogV2 extends StatefulWidget {
  const AddDeviceDialogV2({super.key});

  @override
  State<AddDeviceDialogV2> createState() => _AddDeviceDialogV2State();
}

class _AddDeviceDialogV2State extends State<AddDeviceDialogV2> {
  int _currentStep = 0;
